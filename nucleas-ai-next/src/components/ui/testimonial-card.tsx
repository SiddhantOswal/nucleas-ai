...
export function TestimonialCard({ author, text, href }: TestimonialCardProps) {
  return (
    <div className="relative w-80 cursor-pointer overflow-hidden rounded-xl border border-gray-50/[.1] bg-gray-50/[.10] hover:bg-gray-50/[.15]">
      <div className="flex flex-row items-center gap-1 p-6">
        <div className="flex flex-col overflow-hidden">
          ...
          <blockquote className="text-sm text-gray-100 font-semibold leading-relaxed">
            {text}
          </blockquote>
        </div>
      </div>
