...
export const Footer = () => {
  return (
    <footer className="backdrop-blur-md bg-white dark:bg-black text-zinc-700 dark:text-white border-t border-zinc-200 dark:border-white/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/product" className="text-zinc-600 dark:text-gray-400 hover:text-zinc-900 dark:hover:text-white text-sm" aria-label="Product Features">Features</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="text-zinc-600 dark:text-gray-400 hover:text-zinc-900 dark:hover:text-white text-sm" aria-label="About NucleasAI">About</Link></li>
              <li><Link href="/blog" className="text-zinc-600 dark:text-gray-400 hover:text-zinc-900 dark:hover:text-white text-sm" aria-label="NucleasAI Blog">Blog</Link></li>
              ...
              <li><Link href="/contact" className="text-zinc-600 dark:text-gray-400 hover:text-zinc-900 dark:hover:text-white text-sm" aria-label="Contact NucleasAI">Contact</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-zinc-200 dark:border-white/20 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="https://twitter.com/nucleasai" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-gray-400 hover:text-zinc-900 dark:hover:text-white" aria-label="Twitter">
