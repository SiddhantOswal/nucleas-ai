...
export const metadata: Metadata = {
  title: "About NucleasAI | Building the Future of Customer Data",
  description: "Learn about NucleasAI's mission to democratize access to real-time customer intelligence. Meet our team of data infrastructure and AI experts from leading technology companies.",
  keywords: [
    "NucleasAI team",
  ...
  openGraph: {
    title: "About NucleasAI | Building the Future of Customer Data",
    description: "Learn about NucleasAI's mission to democratize access to real-time customer intelligence.",
    url: "https://nucleasai.com/about",
    images: [
      {
        url: "/og-about.png",
        width: 1200,
        height: 630,
        alt: "About NucleasAI - Building the Future of Customer Data",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://nucleasai.com/about",
  },
};
              ...
              "founder": [
                {
                  ...
                  "description": "Former VP of Data at Segment, 10+ years building customer data infrastructure."
                },
                {
                  "@type": "Person",
                  "name": "Sarah Kim",
                  "jobTitle": "CTO & Co-Founder",
                  "description": "Ex-Senior Engineer at Snowflake, expert in real-time data processing and ML."
                }
              ],
              "employee": [
                {
                  ...
                  "description": "Former Product Lead at Adobe, specialized in enterprise data platforms."
                },
                {
                  "@type": "Person",
                  "name": "Emily Watson",
                  "jobTitle": "VP of Engineering",
                  "description": "Previously Staff Engineer at Stripe, focused on scalable data infrastructure."
                }
              ]
            },
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 2,
                  "name": "About",
                  "item": "https://nucleasai.com/about"
                }
              ]
            }
          })
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 p-12 rounded-2xl border border-gray-800">
              ...
              <p className="text-xl text-gray-400 mb-8">
                Ready to transform your customer data strategy? Let's build the future together.
              </p>
              <Button className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-8 py-3 rounded-xl">
                Get Started
