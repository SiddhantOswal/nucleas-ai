...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Contact NucleasAI | AI-Native CDP Support & Demo | Customer Data Platform</title>
        <meta name="description" content="Contact NucleasAI for support, demo requests, or partnership inquiries. Reach out to the leading AI-native customer data platform team." />
        <link rel="canonical" href="https://nucleasai.com/contact" />
        <meta name="keywords" content="Contact NucleasAI, AI-native CDP, customer data platform, support, demo, partnership" />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "itemListElement": [
              ...
              {"@type": "ListItem", "position": 2, "name": "Contact", "item": "https://nucleasai.com/contact"}
            ]
          }
        `}</script>
        ...
        <script type="application/ld+json">{`
          {
            ...
            "@type": "LocalBusiness",
            "name": "NucleasAI",
            "image": "https://nucleasai.com/og-image.png",
            "@id": "https://nucleasai.com/contact",
            "url": "https://nucleasai.com/contact",
