        ...
        <script type="application/ld+json">{`
          {
            ...
            "itemListElement": [
              ...
              {"@type": "ListItem", "position": 2, "name": "Product", "item": "https://nucleasai.com/product"}
            ]
          }
        `}</script>
        ...
        <script type="application/ld+json">{`
          {
            ...
            "@type": "Product",
            "name": "NucleasAI CDP",
            "description": "AI-native customer data platform for real-time data activation and intelligence.",
            "brand": {"@type": "Brand", "name": "NucleasAI"},
