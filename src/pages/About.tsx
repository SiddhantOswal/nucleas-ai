...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About NucleasAI | AI-Native CDP Team & Mission | Customer Data Platform</title>
        <meta name="description" content="Learn about NucleasAI, the team behind the leading AI-native customer data platform. Our mission, values, and expertise in real-time data activation and AI agents." />
        <link rel="canonical" href="https://nucleasai.com/about" />
        <meta name="keywords" content="About NucleasAI, AI-native CDP, customer data platform, team, mission, values" />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "itemListElement": [
              ...
              {"@type": "ListItem", "position": 2, "name": "About", "item": "https://nucleasai.com/about"}
            ]
          }
        `}</script>
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": ["https://twitter.com/nucleasai"]
          }
        `}</script>
      </Helmet>
